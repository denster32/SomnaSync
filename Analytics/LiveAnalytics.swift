...
class LiveAnalytics: ObservableObject {
    ...
    private func setupLiveAnalytics() {
        ...
        Logger.success("Live analytics initialized", log: Logger.performance)
    }
    ...
    func startMonitoring() {
        ...
        Logger.info("Live monitoring started", log: Logger.performance)
    }
    ...
    func stopMonitoring() {
        ...
        Logger.info("Live monitoring stopped", log: Logger.performance)
    }
    ...
    private func generateSummary() -> AnalyticsSummary {
        ...
        let performanceScore = calculateRealTimeMetrics()
